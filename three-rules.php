...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <p>Dalmatian are large dogs with excellent endurance and stamina. They require a minimum of an hour of exercise, once or preferably twice a day, this should include plenty of off lead running and play. Under exercised Dalmatian may suffer from stress, hyperactivity and in extreme cases aggression.</p>
   </div>
    <div class="col-md-4">
      <h2><small>Three</small></h2>
      <h2>Plenty of Fresh Water</h2>
      <p>Dalmatian should always have fresh clean water to drink and have access to outdoors so that they can regularly urinate.</p>
    </div>
  </div>
</div>
