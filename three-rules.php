...
<div class="container">
  <div class="row">
    <div class="col-md-4">
      ...
      <p>Its a misconception that low purines means low protein. Dalmatians need a relatively high protein diet but due to to their unique uric acid metabolism this must be human-grade protein low in purines. Suitable sources of low purine protein sources can be found in our <a href="purine-guide.php">Purine Guide.</a></p>

    </div>
    <div class="col-md-4">
      <h2><small>Two</small></h2>
      <h2>Frequent and Regular Exercise</h2>
      <p>Dalmatian's are large dogs with excellent endurance and stamina. They require a minimum of an hour of exercise, once or preferably twice a day, this should include plenty of off lead running and play. Under exercised Dalmatian may suffer from stress, hyperactivity and in extreme cases aggression.</p>
   </div>
    <div class="col-md-4">
