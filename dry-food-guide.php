  ...
  <div id="products" class="row list-group">
      <div class="item  col-xs-4 col-lg-4">
          <div class="thumbnail">
              <img class="group list-group-image" src="img/dalmatian-royal-canin-adult.png" alt="" />
              <div class="caption">
                  <h4 class="group inner list-group-item-heading">
                      Royal Canin Dalmatian</h4>
                  <p class="group inner list-group-item-text">
                      Complete feed for dogs - Specially for adult and mature Dalmatians - Over 15 months old</p>
                  <div class="row">
                      <div class="col-xs-12 col-md-6">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#product-info">Ingredients</button>
                      </div>
                  </div>
              </div>
          </div>
      ...
      <div id="products" class="row list-group">
          <div class="item  col-xs-4 col-lg-4">
              <div class="thumbnail">
                  <img class="group list-group-image" src="img/dalmatian-royal-canin-junior.png" alt="" />
                  <div class="caption">
                      <h4 class="group inner list-group-item-heading">
                          Royal Canin Dalmatian Junior</h4>
                      <p class="group inner list-group-item-text">
                          Complete feed for dogs - Specially for Dalmatian puppies - Up to 15 months old</p>
                      <div class="row">
                          <div class="col-xs-12 col-md-6">
                              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#product-info">Ingredients</button>
                          </div>
