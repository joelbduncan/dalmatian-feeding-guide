...
<div class="container">
  ...
  <div class="row">
      <div class="col-lg-12">
          <h1 class="page-header">Our Friends
  ...
  <!-- /.row -->
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 mt-4">
        <div class="card card-inverse card-info">
            <img class="card-img-top" src="img/cyprus-house-pride-banner.jpg">
            <div class="card-block">
                <h4 class="card-title">Cyprus Pride House</h4>
                <div class="card-text">
                    We find forever homes for rescued Cyprus cats and dogs.
                    <a href="http://cypruspridehouse.org/about/">Read our story</a>
                </div>
            </div>
    ...
    <div class="col-sm-6 col-md-6 col-lg-6 mt-4">
        <div class="card card-inverse card-info">
            ...
            <div class="card-block">
                ...
                <div class="card-text">
                    The FERGUSA Dog Food Company is here to provide the discerning dog owner with premium dog food at practical prices.
                </div>
            </div>
            <div class="card-footer">
